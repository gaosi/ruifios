...
public class P3pMain 
{
	...
	public static void main(String[] args) {
		if (args.length < 6) {
			...
			System.out.println(P3pMain.class.getSimpleName()+" <主机> <port> <同时开启的线程数> <URI> <参数> <连接超时> [<代理主机> <代理端口>]");
			System.out.println("");
			System.exit(0);
